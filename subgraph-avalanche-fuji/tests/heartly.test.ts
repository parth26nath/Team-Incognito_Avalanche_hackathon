...
describe("Describe entity assertions", () => {
  beforeAll(() => {
    ...
    let newBalanceWithdrawnEvent = createBalanceWithdrawnEvent(user, amount)
    handleBalanceWithdrawn(newBalanceWithdrawnEvent)
  })
  ...
  test("BalanceWithdrawn created and stored", () => {
    assert.entityCount("BalanceWithdrawn", 1)
